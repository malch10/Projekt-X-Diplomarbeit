...
pfad = 'C:/Users/erikm/Desktop/Diplomarbeit Erik Marr/Daten/Ausgangsdaten/I9000_F5000'

# Finde alle Dateien, die auf '_valu.txt' enden
valu_dateien = glob.glob(pfad + '/*_valu.txt')

# Zeile und Spalten festlegen (Nur jede vierte Zeile/Spalte einlesen)
